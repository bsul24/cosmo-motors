...
import { fetchSales, fetchSalespeople } from '@/app/lib/data';
              ...
              >
                <div className="flex w-full items-center justify-between pt-4">
                  <div>
                    ...
                    <p>VEHICLE: {sale.make + ' ' + sale.model + ' ' + sale.year + ' ' + sale.color}</p>
                    <p>DEALERSHIP: {sale.dealershipName}</p>
                    <p>SALESPERSON: {sale.salespersonFirstName + ' ' + sale.salesPersonLastName}</p>
                    <p>CUSTOMER: {sale.customerFirstName + ' ' + sale.customerLastName}</p>
                  </div>
                ...
                >
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
                    <div className="flex items-center gap-3">
                      <p>{sale.make + ' ' + sale.model + ' ' + sale.year + ' ' + sale.color + ' - ' + sale.price}</p>
                    </div>
                  </td>
