...
export function UpdateVehicle({ vehicleID }: { vehicleID: number }) {
  return (
    <Link
...
export function DeleteVehicle({ vehicleID }: { vehicleID: number}) {
  const deleteVehicleWithId = deleteVehicle.bind(null, vehicleID);
  return (
